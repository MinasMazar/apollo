...
#
#     PHX_SERVER=true bin/apollo start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :apollo, ApolloWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :apollo, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :apollo, ApolloWeb.Endpoint,
    url: [host: host, port: 443, scheme: "https"],
    check_origin: ["//localhost", "//#{host}", "//apollo.minasmazar.org"],
    http: [
